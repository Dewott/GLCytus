...
public class ImageHandle {
	...
	public double[] getPts() {
		...
		if(!rotated){
		texPts[0] = s;texPts[1] = t;
		texPts[2] = s;texPts[3] = t2;
		texPts[4] = s2;texPts[5] = t2;
		texPts[6] = s2;texPts[7] = t;
		}
		else{
		texPts[0]=s2;texPts[1]=t;
		texPts[2]=s;texPts[3]=t;
		texPts[4]=s;texPts[5]=t2;
		texPts[6]=s2;texPts[7]=t2;
        }
